namespace Exercice_5_MVC.Service
{
    ...
    namespace Exercice_4_MVC.Service
    {
        public class WarehouseService
        {
            ...
            internal void Update(Warehouse warehouseUpdated)
            {
                var warehouseBdd =   dbContext.Warehouses.SingleOrDefault(w => w.Id == warehouseUpdated.Id);
                warehouseBdd = warehouseUpdated;
            }
        }
    }
